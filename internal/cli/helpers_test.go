...
// captureStdout replaces os.Stdout and installer.Stdout with a pipe,
// runs fn, and returns everything written to stdout as a string.
func captureStdout(t *testing.T, fn func()) string {
	t.Helper()
	old := os.Stdout
	oldInstaller := installer.Stdout
	r, w, err := os.Pipe()
